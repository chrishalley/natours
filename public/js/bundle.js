...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY2hyaXNoYWxsZXk4NiIsImEiOiJja2FzZ242aHUwanVjMnBvNW43ZHFwZXQwIn0.OCr_KnBZPF3GUEn8UvqVYw';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            url = "http://localhost:8000/api/v1/users/".concat(type === 'password' ? 'updateMyPassword' : 'updateMe');
            _context.prev = 3;
            _context.next = 6;
            return (0, _axios.default)({
              method: 'PATCH',
          ...
          case 6:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type === 'password' ? 'Password' : 'Details', " updated successfully!"));
              window.setTimeout(function () {
                location.reload(true);
              }, 1500);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _stripeJs.loadStripe)('pk_test_Q2uIPat3JzdBlAYwytp9OcaG');
...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var button, passwordCurrent, password, passwordConfirm;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
